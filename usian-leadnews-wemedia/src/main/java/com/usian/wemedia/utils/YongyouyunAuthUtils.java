...
//     文章内容 文字 检测
    public static final String WENZIJC="https://api.yonyoucloud.com/apis/dst/APILinkLexicalAnalysis/TextErrorCorrection";
//     文章素材 检测
    public static final String SCJC="https://api.yonyoucloud.com/apis/dst/ContentAudit_CompositeServices/ContentAudit_CompositeServices";
